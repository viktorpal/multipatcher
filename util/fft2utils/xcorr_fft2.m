function y = xcorr_fft2(x, m, shape)
%XCORR_FFT2 Two dimensional crosscorrelation via the FFT.
%   Y = XCORR_FFT2(X, M) performs the 2-D crosscorrelation of matrices X and M.
...
%
%   XCORR_FFT2 uses multiplication in the frequency domain to compute the
...
%
%   See also XCORR2, CONV2, CONVOLVE2, FILTER2.

% Copyright Krisztian Koos, August 2017
...
y = ifft2(fft2(x) .* conj(fft2(m)));   % central operation, basic form
