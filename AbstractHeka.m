classdef AbstractHeka < AbstractAmplifier & handle
    ...
    methods
        ...
        function startup(this)
            this.giveOrder('OpenOnlineFile multipatcher.onl');
            this.giveOrder('OpenPgfFile multipatcher.pgf');
            this.giveOrder('OpenProtFile multipatcher.pro');
        end
        ...
        function setup(this, reset)
            ...
            if reset
                this.giveOrder('ExecuteProtocol RESET');
            end
        end
        
        function beforeHunt(this)
            this.setup(false);
            this.giveOrder('ExecuteProtocol bHunt');
        end
        ...
        function beforeBreakin(this)
            ...
            this.giveOrder('Set E AutoCFast'); % fast capacitive compensation
            this.giveOrder('Set N  Store FALSE'); % don't store recording
            this.giveOrder('ExecuteProtocol bBreakin');
        end
        ...
        function afterBreakIn(this)
            ...
            this.giveOrder('ExecuteProtocol aBreakin');
        end
